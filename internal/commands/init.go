...
var initCmd = &cobra.Command{
	Use:   "init",
	Short: "Initialize ndiff configuration",
	Long: `Interactive setup wizard to create a configuration file.

This command guides you through creating a ndiff.toml configuration
...
func initRun(cmd *cobra.Command, args []string) error {
	...
	PrintInfo("🚀 Welcome to ndiff setup!")
	fmt.Println()
	...
	config.WriteString("# ndiff configuration\n")
	config.WriteString("# Generated by: ndiff init\n\n")
