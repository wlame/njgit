// Package version provides version information for the nomad-changelog binary.
...
var (
	...
	// Set via: -ldflags "-X github.com/wlame/nomad-changelog/pkg/version.Version=1.0.0"
	Version = "dev"

	// Commit is the git commit hash the binary was built from
	// Set via: -ldflags "-X github.com/wlame/nomad-changelog/pkg/version.Commit=abc123"
	Commit = "unknown"

	// BuildTime is when the binary was built (RFC3339 format)
	// Set via: -ldflags "-X github.com/wlame/nomad-changelog/pkg/version.BuildTime=2025-11-26T10:30:00Z"
	BuildTime = "unknown"
)
...
// Format: "nomad-changelog version <version> (commit: <commit>, built: <buildtime>)"
// Example output: "nomad-changelog version 1.0.0 (commit: abc123, built: 2025-11-26T10:30:00Z)"
func String() string {
	return fmt.Sprintf("nomad-changelog version %s (commit: %s, built: %s)",
